...
В приложении появился раздел **Google Colab**: калибровка, анализ, остановка, скачивание и прогресс. Код можно открыть и скопировать повторно. Связь с закрытым блокнотом не считается постоянной; можно переподключить тот же блокнот, сохранив проверенную калибровку.
