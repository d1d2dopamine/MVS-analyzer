> HISTORICAL DEVELOPMENT SNAPSHOT — preserved for traceability. Superseded by the root changelog and current METHODS/VALIDATION. Old claims are not validation of engine 1.6.0.
