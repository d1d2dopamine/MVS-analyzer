...
Environment.SetEnvironmentVariable("MVS_DISABLE_BACKUPS", "1");
...
}.Concat(ScientificChecks.All).Concat(SerializationChecks.All).Concat(ColabChecks.All).Concat(ColabBridgeChecks.All).Concat(BackupChecks.All).ToArray();
